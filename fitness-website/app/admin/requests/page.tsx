  ...
  return (
    <AdminLayout>
      <div className="space-y-8 p-6 bg-slate-50 min-h-screen">
        ...
        <Tabs
          value={activeTab}
          onValueChange={(v) => setActiveTab(v as RequestSection)}
          className="space-y-6"
        >
          <TabsList className="grid w-full grid-cols-3 bg-slate-400 p-1 rounded-lg">
            <TabsTrigger
              value="training"
              className="hover:bg-slate-300/50 hover:text-slate-900 transition-colors data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-indigo-700 font-medium rounded-md"
            >
