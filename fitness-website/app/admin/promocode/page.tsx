...
const StatsCards = dynamic(() => import("@/components/admin/promocodes").then(mod => mod.StatsCards), { 
...
const SearchAndFilter = dynamic(() => import("@/components/admin/promocodes").then(mod => mod.SearchAndFilter), { 
  loading: () => <div className="h-16 bg-gray-100 animate-pulse rounded-lg mb-6" />
});
const PromoCodeTable = dynamic(() => import("@/components/admin/promocodes").then(mod => mod.PromoCodeTable), { 
  loading: () => <div className="h-96 bg-gray-100 animate-pulse rounded-lg" />
});
const PromoCodeForm = dynamic(() => import("@/components/admin/promocodes").then(mod => mod.PromoCodeForm), { 
  loading: () => <div className="h-80 bg-gray-100 animate-pulse rounded-lg" />
});
const DeleteConfirmation = dynamic(() => import("@/components/admin/promocodes").then(mod => mod.DeleteConfirmation), { 
  loading: () => <div className="h-48 bg-gray-100 animate-pulse rounded-lg" />
});
const ActionButtons = dynamic(() => import("@/components/admin/promocodes").then(mod => mod.ActionButtons), { 
