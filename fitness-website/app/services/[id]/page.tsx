...
import { useServiceDetail } from "@/hooks/queries";
...
export default function ServiceDetailsPage() {
  ...
  const [requestStatus, setRequestStatus] = useState<
    "none" | "pending" | "approved" | "cancelled"
  >("none");
    ...
    const fetchMyRequests = async () => {
      ...
      try {
        ...
        const res = await fetch(
          API_CONFIG.USER_FUNCTIONS.requests.training.getMyRequests,
          {
            method: "POST",
            headers: {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      if (requestStatus === "approved") {
        setSubmitError(
          "You already have an approved training request. You cannot submit another one.",
        );
        return;
      }
      setSubmitError(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 pt-20">
          ...
          <Card className="border-0 shadow-sm">
            <CardContent className="p-0">
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-gray-100">
                <Image
                  src={
                    getProxyImageUrl(service.image || undefined) ||
                    "/placeholder.svg"
                  }
                  alt={
                    service?.title
            ...
            {justSubmitted && (
              <Alert className="border-green-200 bg-green-50">
                ...
                <AlertDescription className="text-green-800">
                  Your request has been sent successfully and is now pending
                  review.
                </AlertDescription>
              </Alert>
            )}
            {requestStatus === "pending" && !justSubmitted && (
              <Alert className="border-amber-200 bg-amber-50">
                ...
                <AlertDescription className="text-amber-800">
                  You have a pending training request. We will notify you once
                  it is approved.
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Work with certified coaches to reach your goals safely and
                    effectively.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose times that fit your routine, mornings to evenings.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-card border rounded-lg p-4 sm:p-6">
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="f1">
              ...
              <AccordionContent>
                We provide the essentials. If you prefer, you can bring your own
                training gear.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="f2">
              ...
              <AccordionContent>
                Yes, you can reschedule with advance notice. Availability may
                vary by coach.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
      ...
      <Dialog
        open={isBookingOpen}
        onOpenChange={(open) => !isSubmitting && setIsBookingOpen(open)}
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => handleFormChange("trainingPlace", v)}
                >
                  <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleFormChange("goalDescription", e.target.value)
                }
              />
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFormChange("trainingPerWeek", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleFormChange("injuryDetails", e.target.value)
                  }
                />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <Textarea
                id="diseasesDetails"
                rows={2}
                value={form.diseasesDetails}
                onChange={(e) =>
                  handleFormChange("diseasesDetails", e.target.value)
                }
              />
            </div>
