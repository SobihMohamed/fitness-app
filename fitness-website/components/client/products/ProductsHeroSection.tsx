...
export default function ProductsHeroSection({
  ...
  return (
    <section
      className={`py-12 lg:py-20 bg-gradient-to-b from-white to-gray-50 ${className}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl max-w-3xl mx-auto text-muted leading-relaxed">
          Discover our curated collection of high-quality fitness equipment and
          supplements designed to help you achieve your goals and maintain a
          healthy lifestyle.
        </p>
      </div>
    </section>
