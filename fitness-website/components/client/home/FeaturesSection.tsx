...
const features: Feature[] = [
  {
    ...
    description:
      "Premium fitness products, supplements, and equipment with secure checkout.",
    href: "/products",
    color: "text-blue-600",
    bgColor: "bg-blue-100",
  },
  {
    ...
    description:
      "Expert-led fitness courses and training programs for all levels.",
    href: "/courses",
  ...
  },
  {
    ...
    description:
      "Book sessions with certified trainers tailored to your goals.",
    href: "/services",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl max-w-2xl mx-auto" style={{ color: "#6C757D" }}>
            Everything you need in one powerful platform - from shopping to
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature) => (
            <Card
              key={feature.title}
              className="transition-all duration-300 border-0 shadow-md bg-white"
            >
