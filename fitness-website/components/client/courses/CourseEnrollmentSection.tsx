...
const CourseEnrollmentSection = React.memo<CourseEnrollmentSectionProps>(
  ({ course, onEnrollment }) => {
    ...
    const discountValue =
      promoCode.trim().toUpperCase() === "DISCOUNT10" ? 10 : 0; // sample rule
    ...
    const handleSubmitRequest = async () => {
      try {
        ...
        const data = await makeAuthenticatedRequest(
          API_CONFIG.USER_FUNCTIONS.requests.courses.create,
          {
            method: "POST",
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Complete the form to submit your request for{" "}
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border p-3 text-sm">
                <div className="flex items-center justify-between py-1">
                  ...
                  <span className="font-semibold">
                    {formatNumber(originalTotal)} EGP
                  </span>
                </div>
                <div className="flex items-center justify-between py-1">
                  <span className="text-muted-foreground">Discount</span>
                  <span className="font-semibold">
                    {formatNumber(discountValue)} EGP
                  </span>
                </div>
