...
const CoursesClientPage = React.memo(
  ({ initialCourses = [] }: CoursesClientPageProps) => {
    const {
      courses,
      loading,
      filter,
    ...
    const hasValidData = useMemo(() => courses && !loading, [courses, loading]);
...
CoursesClientPage.displayName = "CoursesClientPage";
