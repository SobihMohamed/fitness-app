...
import { PageHeroClient } from "@/components/shared/page-hero-client";
    ...
    return (
      <>
        ...
        <PageHeroClient
          ...
          title="Fitness"
          highlight="Blog"
          description="Discover expert insights, industry trends, and practical guides to help you stay ahead"
        />
                    ...
                    <div className="flex items-center justify-between mb-8">
                      <div className="flex items-center gap-3 text-gray-600">
                        ...
                        <span className="font-medium">
                          ...
                          !isNaN(new Date(featuredPost.createdAt).getTime())
                            ? new Date(
                                featuredPost.createdAt,
                              ).toLocaleDateString()
                            : "Recently"}
