      ...
      >
        <div className={featured ? "relative" : "md:flex"}>
          <div className={featured ? "h-64" : "md:w-2/5"}>
            <div
              className={`${featured ? "h-64" : "h-48 md:h-52"} bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center relative overflow-hidden`}
            >
              {imageSrc && imageOk ? (
                <img
                  src={imageSrc}
          ...
          {!featured && (
            <div className="md:w-3/5 p-6 min-w-0">
              <div className="mb-4">
                <Badge className="bg-primary/10 text-primary border border-primary/20 px-3 py-1 text-sm font-medium group-hover:bg-primary group-hover:text-white group-hover:border-primary max-w-full truncate">
                  {displayCategoryName}
                </Badge>
              </div>

              <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-blue-700 transition-colors duration-200 line-clamp-2 leading-tight break-all hyphens-auto">
                {blog.title}
              </h3>

              <p className="text-gray-600 mb-4 line-clamp-3 leading-relaxed break-all hyphens-auto">
                {blog.excerpt}
              </p>
