...
export default function ChapterDetailsInfo({
  chapter,
}: ChapterDetailsInfoProps) {
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="prose prose-gray max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed">
                This chapter builds upon the concepts from previous lessons and
                introduces new techniques that will enhance your understanding
                and practical skills. Pay close attention to the demonstrations
