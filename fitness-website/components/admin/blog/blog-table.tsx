                ...
                {paginatedBlogs.map((blog) => (
                  ...
                  >
                    ...
                    <TableCell className="py-4">
                      ...
                      >
                        {blog.status === "published" ? "Published" : "Archived"}
                      </Badge>
                    </TableCell>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 py-6 px-6 border-t bg-gradient-to-r from-white to-slate-50">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="h-9 px-3 rounded-lg shadow-sm hover:shadow transition-all duration-200 border-slate-200 text-slate-700 hover:text-slate-800"
                  >
                        ...
                        <Button
                          ...
                          className={`h-9 w-9 p-0 rounded-lg shadow-sm hover:shadow transition-all duration-200 ${
                            currentPage === page
                              ...
                              : "hover:bg-slate-50 border-slate-200 text-slate-700 hover:text-slate-800"
                          }`}
                        >
                          {page}
                        </Button>
