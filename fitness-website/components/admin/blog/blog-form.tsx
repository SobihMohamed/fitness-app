...
export const BlogForm = React.memo(
  ({
    ...
    const handleImageChange = useCallback(
      ...
      [onImageChange, showErrorToast],
    );

    const handleRemoveImage = useCallback(() => {
      onImageChange(null);
      // Clear in local and parent form data
      const updated = { ...localFormData, main_image: null as any };
    ...
    }, [localFormData, onFormDataChange, onImageChange]);
          ...
          <form onSubmit={onSubmit} className="space-y-6 p-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="text-xs text-slate-500 mt-1">
                  {localFormData.title?.length || 0}/100
                </div>
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                />
                <div className="text-xs text-slate-500 mt-1">
                  {localFormData.content?.length || 0}/2000
                </div>
                {formErrors.content && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                ...
                <div className="md:col-span-2">
                  ...
                  {(selectedImage || localFormData.main_image) && (
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 mt-2">
                      ...
                      <Button
                        ...
                        disabled={isSubmitting}
                        className="w-max text-red-700 hover:text-red-800 border-red-200 hover:bg-red-50 rounded-lg"
                      >
                        Remove Image
                      </Button>
                    </div>
            ...
            <DialogFooter className="flex gap-3 pt-6 border-t border-slate-100">
              <Button
                ...
                onClick={onClose}
                disabled={isSubmitting}
                className="px-6 bg-transparent rounded-lg hover:bg-slate-50 text-slate-700 hover:text-slate-800 transition-colors duration-200"
              >
                Cancel
              </Button>
              <Button
