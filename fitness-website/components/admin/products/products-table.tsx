            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50 border-b border-slate-200">
                  ...
                  <TableHead className="w-32 font-medium text-slate-600 py-3 px-6">
                    Stock
                  </TableHead>
                  ...
                  >
                    ...
                    <TableCell className="py-4 px-6 align-top">
                      <div className="max-w-[280px]">
                        <p className="font-medium text-slate-800 mb-1 line-clamp-2 break-words">
                          {product.name}
                        </p>
                      </div>
                    </TableCell>
                    <TableCell className="py-4 px-6">
                      <Badge
                        variant="default"
                        className="bg-indigo-100/80 text-indigo-700 hover:bg-indigo-100 px-2.5 py-1 rounded-md font-medium inline-flex items-center gap-1 whitespace-nowrap"
                      >
                        {product.price} EGP
                      </Badge>
                    </TableCell>
                    <TableCell className="py-4 px-6">
                      <Badge
                        variant="outline"
                        className="bg-slate-50 text-slate-700 border-slate-200 max-w-[220px] whitespace-normal break-words text-left justify-start"
                      >
                    ...
                    <TableCell className="py-4 px-6">
                      <Badge
                        variant={
                          product.is_in_stock === "1" ? "default" : "secondary"
                        }
                        className={
                          product.is_in_stock === "1"
                            ? "bg-emerald-100/80 text-emerald-700 hover:bg-emerald-100 px-2.5 py-1 rounded-md font-medium whitespace-nowrap inline-flex"
                            : "bg-red-100/80 text-red-700 hover:bg-red-100 px-2.5 py-1 rounded-md font-medium whitespace-nowrap inline-flex"
                        }
                      >
                        {product.is_in_stock === "1"
                          ? "In Stock"
