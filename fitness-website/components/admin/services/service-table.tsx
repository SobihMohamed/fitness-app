            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50 border-b border-slate-200">
                  ...
                  <TableHead className="w-40 text-right font-semibold text-slate-700">
                    Actions
                  </TableHead>
                </TableRow>
              </TableHeader>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end items-center gap-2">
                        <Button
                          ...
                          className="h-9 w-9 p-0 hover:bg-blue-50 hover:border-blue-200 transition-all duration-150"
                        >
