                    ...
                    <div className="flex flex-col items-start text-left w-full">
                      ...
                      <div className="text-xs text-slate-500 mt-2 flex gap-6">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          Created:{" "}
                          {module.created_at
                            ? formatDateTimeDDMMYYYYHHmm(module.created_at)
                            : "-"}
                        </span>
                      </div>
                    </div>
                      ...
                      <Table className="border border-slate-200 rounded-lg overflow-hidden">
                        <TableHeader>
                          <TableRow className="bg-slate-50 border-b border-slate-200">
                            <TableHead className="min-w-[150px] sm:min-w-[220px] font-semibold text-slate-700">
                              Title
                            </TableHead>
                            <TableHead className="hidden md:table-cell min-w-[260px] font-semibold text-slate-700">
                              Description
                            </TableHead>
                            <TableHead className="w-20 sm:w-40 font-semibold text-slate-700">
                              Video
                            </TableHead>
                            <TableHead className="w-16 sm:table-cell font-semibold text-slate-700">
                              Order
                            </TableHead>
                            <TableHead className="hidden sm:table-cell w-48 font-semibold text-slate-700">
                              Created
                            </TableHead>
                            <TableHead className="w-20 sm:w-28 text-right font-semibold text-slate-700">
                              Actions
                            </TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {(chaptersByModule[moduleKey] || []).map(
                            (chapter, idx) => (
                              <TableRow
                          ...
                          {(!chaptersByModule[moduleKey] ||
                            chaptersByModule[moduleKey].length === 0) && (
                            <TableRow>
                              <TableCell
                                colSpan={6}
