...
export const getApiBaseUrl = () => env.NEXT_PUBLIC_API_BASE_URL || env.NEXT_PUBLIC_API_URL;
// Old: export const getApiTargetUrl = () => env.NEXT_PUBLIC_API_TARGET_URL || env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8000";
export const getApiTargetUrl = () => env.NEXT_PUBLIC_API_TARGET_URL || env.NEXT_PUBLIC_API_BASE_URL || env.NEXT_PUBLIC_API_URL;
